...
class navigator:
        ...
        def movies(self, lite=False):
                if inprogress_db == 'true':
                        self.addDirectoryItem(32104,       'movieProgress',         'trending.png',      'DefaultMovies.png')
                self.addDirectoryItem(32035,               'movies&url=featured',   'featured.png',      'DefaultRecentlyAddedMovies.png')
#		self.addDirectoryItem('Trending',          'movies&url=trending',   'trending.png',      'DefaultRecentlyAddedMovies.png')
                self.addDirectoryItem(32088,               'movies&url=popular',    'populars.png',      'DefaultMovies.png')
                self.addDirectoryItem(32005,               'movies&url=premiere',   'trending.png',      'DefaultRecentlyAddedMovies.png')
                self.addDirectoryItem(32089,               'movies&url=views',      'most-viewed.png',   'DefaultMovies.png')
                self.addDirectoryItem(32324,               'movies&url=theaters',   'in-theaters.png',   'DefaultRecentlyAddedMovies.png')
                self.addDirectoryItem(32090,               'movies&url=tmdbmarvel', 'marvel.png',        'DefaultRecentlyAddedMovies.png')
                self.addDirectoryItem(32091,               'movies&url=tmdboscars', 'oscars.png',        'DefaultRecentlyAddedMovies.png')
                self.addDirectoryItem(32092,               'movies&url=tmdbdisney', 'disney.png',        'DefaultRecentlyAddedMovies.png')
                self.addDirectoryItem(32093,               'collectionsMovies',     'collection.png',    'DefaultMovies.png')
                self.addDirectoryItem(32094,               'kidsCollections',       'kidscollection.png', 'DefaultMovies.png')
                self.addDirectoryItem(32095,               'holidayCollections',    'holidaycollections.png', 'DefaultMovies.png')
                self.addDirectoryItem(32102,               'movieGenres',           'genres.png',        'DefaultMovies.png')
                self.addDirectoryItem(32103,               'movieYears',            'years.png',         'DefaultMovies.png')
                self.addDirectoryItem(32096,               'moviePersons',          'people.png',        'DefaultMovies.png')
        ...
        def tvshowst(self, lite=False):
                ...
                if traktIndicators == True:
                        ...
                        self.addDirectoryItem(32097, 'calendar&url=mycalendar', 'trakt.png', 'DefaultRecentlyAddedEpisodes.png', queue=True)
                self.addDirectoryItem(32329, 'tvUserlists', 'mytvshows.png', 'DefaultTVShows.png')
                if traktCredentials == True:
                        self.addDirectoryItem(32099, 'episodeUserlists', 'mytvshows.png', 'DefaultTVShows.png')
                if lite == False:
                        self.addDirectoryItem(32002, 'tvliteNavigator', 'tvshows.png', 'DefaultTVShows.png')
                        self.addDirectoryItem(32098, 'tvPerson', 'actorsearch.png', 'DefaultTVShows.png')
                        self.addDirectoryItem(32010, 'tvSearch', 'search.png', 'DefaultTVShows.png')
                self.endDirectory()

        def tvshows(self, lite=False):
                if inprogress_db == 'true': self.addDirectoryItem("In Progress", 'showsProgress', 'trending.png', 'DefaultMovies.png')
                self.addDirectoryItem(32035, 'tvshows&url=featured', 'populars.png', 'DefaultRecentlyAddedEpisodes.png')
                self.addDirectoryItem(32088, 'tvshows&url=popular', 'most-viewed.png', 'DefaultTVShows.png')
                ...
                self.addDirectoryItem(32100, 'kidstvCollections', 'kidscollection.png', 'DefaultMovies.png')
                self.addDirectoryItem(32101, 'tvCollections', 'collection.png', 'DefaultMovies.png')
        ...
        def tools(self):
                self.addDirectoryItem(33001, 'urlresolversettings&query=0.0', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem(32044, 'openSettings&query=2.1', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32047, 'nanscrapersettings&query=1.1', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32080, 'openSettings&query=2.8', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32048, 'openSettings&query=3.0', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32046, 'openSettings&query=4.0', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32081, 'openSettings&query=5.0', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32082, 'openSettings&query=6.1', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32083, 'openSettings&query=7.1', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32084, 'viewsNavigator', 'tools.png', 'DefaultAddonProgram.png')
                ...
                self.addDirectoryItem(32085, 'backupwatchlist', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32086, 'restorewatchlist', 'tools.png', 'DefaultAddonProgram.png')
                self.addDirectoryItem(32087, 'clearProgress', 'tools.png', 'DefaultAddonProgram.png')
                self.endDirectory()
